...
export const products: Product[] = [
  {
    ...
    variants: [
      {
        id: 1,
        translationKey: "PigIron.Variants.FoundryGrade",
        ...
        specifications: [
          {
            key: "Grade",
            value: "Foundry Grade Pig Iron",
          },

          {
            key: "Packing",
            value: "Loose / 1 MT Jumbo Bag",
          },
          {
            key: "Standard",
            value: "IS / ASTM / ISO Equivalent",
          },
          {
            key: "Origin",
            value: "India",
        ...
        applications: [
          ...
          "Pipe & Pipe Fittings",
          "Manhole Covers & Drainage Castings",
        ...
        faq: [
          {
            question: "What is Foundry Pig Iron?",
            answer:
              "Foundry Pig Iron is a high-quality raw material used in the production of grey iron castings. It offers excellent fluidity, machinability, and consistent chemical composition for foundry applications."
          },
          {
            question: "What grades of Foundry Pig Iron do you supply?",
            answer:
              "We supply various Foundry Pig Iron grades, including L1, L2, L3, L4, L5, L6, and L5–L6 Low Mn, based on customer requirements."
          },
          {
            question: "What are the applications of Foundry Pig Iron?",
            answer:
              "Foundry Pig Iron is widely used for manufacturing grey iron castings, automotive components, machine parts, pipes, manhole covers, agricultural equipment, and engineering castings."
          },
          {
            question: "What packing options are available?",
            answer:
              "The product is supplied in loose bulk, palletized loads, or 1 MT jumbo bags, depending on customer and export requirements."
          },
          {
            question: "Can you provide customized grades and specifications?",
            answer:
              "Yes. We can supply different Foundry Pig Iron grades and specifications according to customer requirements and applicable industry standards."
          },
          {
            question: "Do you export Foundry Pig Iron internationally?",
            answer:
              "Yes. We supply and export Foundry Pig Iron to domestic and international markets with reliable sourcing, quality assurance, and timely delivery."
          }
        ]
      },

      {
        ...
        specifications: [
          {
            key: "Grade",
            value: "Basic Pig Iron",
          },
          {
            key: "Packing",
            value: "Loose / 1 MT Jumbo Bags / Bulk",
          },
          {
            key: "Standard",
            value: "IS / ASTM / ISO Equivalent",
...

      {
        ...
        specifications: [
          {
            key: "Grade",
            value: "Nodular (SG) Grade Pig Iron",
          },
          {
            key: "Packing",
            value: "Loose / 1 MT Jumbo Bags / Bulk",
  ...
  //   specification: [
  //     { key: "Grades", value: "API 5L / ASTM A106 / A53" },
  //     { key: "ODRange", value: "1/2\" – 48\"" },
  //     { key: "WallThickness", value: "SCH 10 – SCH 160" },
  //     { key: "Ends", value: "Beveled / Threaded / Plain" },
  //     { key: "Coating", value: "FBE / 3LPE available" },
  //   ],
  //   applications: [
  //     "Oilgastransmission",
  //     "Waterinfrastructure",
  ...
  //   specifications: [
  //     { key: "Products", value: "Bauxite, Fluorspar, Quartz" },
  //     { key: "Purity", value: "Grade-specific" },
  //     { key: "Moisture", value: "≤ 10%" },
  //     { key: "Packaging", value: "Bulk / Jumbo bags" },
  //     { key: "Inspection", value: "SGS / Bureau Veritas" },
  //   ],
  //   applications: [
  //     "Steelfluxing",
  //     "Aluminumsmelting",
  ...
  //   featured: true,
  //   specifications: [
  //     { key: "IronOreFe", value: "62 – 65%" },
  //     { key: "MetCokeCSR", value: "≥ 62" },
  //     { key: "PCICoal", value: "≤ 10% ash" },
  //     { key: "Delivery", value: "FOB / CIF / CFR" },
  //     { key: "Volumes", value: "5,000 – 75,000 MT" },
  //   ],
  //   applications: [
