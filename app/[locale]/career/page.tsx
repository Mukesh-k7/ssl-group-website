...
export default function CareersPage({ i }: { i: number }) {
  ...
  const STATS = [
    { value: "20+", label: "yearsOfOperations" },
      ...
      <section className="relative min-h-screen flex items-center pt-16 overflow-hidden bg-[#858585a8] ">
        ...
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #F7941D, #fcaf1c, #5B2A00)",
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row gap-3 mb-10">
            <div className="relative flex-1">
              <svg className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <input
                ...
                className="w-full bg-[#0D1520] border border-white/10 rounded-lg pl-10 pr-4 py-3 text-sm text-white placeholder:text-white/60 focus:outline-none focus:border-[#F97316]/50 transition-colors"
              />
            </div>
            <select
              value={selectedDept}
