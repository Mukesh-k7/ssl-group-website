          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-[#94A3B8] leading-relaxed text-base">
                ...
                contractors worldwide since 1996. When you join our team, you become part of supply chains that
                feed real infrastructure — bridges, factories, and energy grids across continents.
              </p>
              <a
                href="#"
                className="inline-flex items-center gap-2 mt-8 text-[#F97316] font-semibold text-sm hover:gap-3 transition-all"
              >
                Read Our Story
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${i === 1 ? "bg-[#F97316]/20" : "bg-white/5"}`}>
                    <svg className={`w-4 h-4 ${i === 1 ? "text-[#F97316]" : "text-[#475569]"}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <div key={i} className="relative">
                ...
                <div className="bg-[#0D1520] border border-white/5 rounded-2xl p-6 hover:border-[#F97316]/20 transition-colors group">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div className="text-3xl font-black text-[#1E2A3A]">{step.step}</div>
                  </div>
