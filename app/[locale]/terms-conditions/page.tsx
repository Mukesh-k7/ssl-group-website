  ...
  const sections = [
    {
      ...
      content: <p>{t("TermsConditions")}</p>,
    },
    {
      title: t("AboutSSLGroup"),
      content: <p>{t("informational")}</p>,
    },
    {
      title: t("Website"),
      content: (
    ...
    },
    {
      ...
      content: <p>{t("reproduction")}</p>,
    },
    {
      title: t("ThirdParty"),
      content: <p>{t("convenience")}</p>,
    },
    {
      title: t("Liability"),
      content: <p>{t("consequential")}</p>,
    },
    {
      title: t("Disclaimer"),
      content: <p>{t("warranties")}</p>,
    },
    {
      title: t("Privacy"),
      content: <p>{t("PrivacyPolicy")}</p>,
    },
    {
      title: t("ChangestoTerms"),
      content: <p>{t("acceptance")}</p>,
    },
    {
      title: t("GoverningLaw"),
      content: <p>{t("jurisdiction")}</p>,
    },
  ];
          ...
          <div className="mt-12 space-y-10">
            {sections.map((section) => (
              <section key={section.title}>
                ...
                <div className="text-gray-700 leading-8">{section.content}</div>
              </section>
            ))}
          </div>
            ...
            <div className="space-y-3 text-gray-700">
              ...
              <ul className="space-y-4">
                ...
                <li>
                  ...
                  >
                    <Phone className="w-4 h-4 text-[#fcaf1c] text-bold" />
                    {company.phone}
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="flex items-center text-sm gap-3"
                  >
                    <Mail className="w-4 h-4 text-[#fcaf1c] text-bold" />
                    {company.email}
                  </a>
                </li>
