  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: "assistant",
      content:
        "Hi! I'm SSL Group's assistant. Ask me about our products, export process, or certifications.",
    },
  ]);
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed right-6 top-1/2 z-1000 flex h-16 w-16 -translate-y-1/2 items-center justify-center rounded-full bg-[#F97316] text-white shadow-lg transition-colors hover:bg-[#EAB308]"
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-1000 flex h-112.5 w-75 flex-col rounded-xl border border-[#F97316]/20 bg-white shadow-2xl">
          ...
          <div className="flex items-center gap-2 border-t bg-white p-3 rounded-md">
            <input
              ...
              className="flex-1 rounded-md border border-gray-300 px-3 py-2 text-sm outline-none focus:border-[#F97316] focus:ring-1 focus:ring-[#F97316] text-black"
            />
            <button
              onClick={sendMessage}
